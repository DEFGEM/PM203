...
export default function ModalScreen() {
  ...
  return (
    <View style={styles.container}>
      {/* <View style={styles.container}>
        <Text>aquie va la practica de Fernando</Text>
      </View> */}
      ...
      >
        ...
        <Pressable
          style={styles.optionButton}
          onPress={() => selectMode("En linea")}
        >
          <Text style={styles.optionTitle}>En linea</Text>
          <Text style={styles.optionText}>
            Recibe el enlace de videollamada.
          </Text>
        </Pressable>

        <Pressable
          style={styles.optionButton}
          onPress={() => selectMode("Grabacion")}
        >
...
const styles = StyleSheet.create({
  ...
  secondaryButton: {
    backgroundColor: "#ffffff",
    borderColor: "#00bbffff",
    borderWidth: 1,
    borderRadius: 8,
    paddingVertical: 14,
    alignItems: "center",
  },
  secondaryButtonText: { color: "#00bbffff", fontSize: 16, fontWeight: "700" },
  overlay: {
    flex: 1,
  ...
  confirmButton: { backgroundColor: "#00bbffff" },
